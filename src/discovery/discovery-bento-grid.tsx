...
export const DiscoveryBentoGrid = ({ lang, goto }: DiscoveryBentoGridProps) => {
 ...
 <main className="row-start-3 grid grid-cols-1 gap-px bg-border md:min-h-0 md:grid-cols-4 md:overflow-y-auto lg:grid-cols-8 lg:grid-rows-[repeat(5,minmax(0,1fr))_84px] lg:overflow-hidden">
 {backstagePost ? (
 <ArticleCard
 post={backstagePost}
 lang={lang}
 ...
 <div className="order-6 flex flex-col gap-px bg-[var(--border)] md:col-span-2 lg:col-start-4 lg:col-span-3 lg:row-start-1 lg:row-span-5 lg:order-none lg:min-h-0">
 {pinnedPost ? (
 <SplitArticleCard
 post={pinnedPost}
 lang={lang}
