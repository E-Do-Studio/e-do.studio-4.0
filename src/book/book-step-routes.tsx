...
export const ConfigStep0 = () => <BookPageV2 forcedStep={0} />;

export const ConfigStep2 = () => {
  const ready = useConfigPrereq(2);
  if (!ready) return null;
  return <BookPageV2 forcedStep={2} />;
};

export const ConfigStep3 = () => {
  const ready = useConfigPrereq(3);
  if (!ready) return null;
  return <BookPageV2 forcedStep={3} />;
};

export const ConfigStep5 = () => {
  const ready = useConfigPrereq(5);
  if (!ready) return null;
  return <BookPageV2 forcedStep={5} />;
};

export const ConfigStep6 = () => {
  const ready = useConfigPrereq(6);
  if (!ready) return null;
  return <BookPageV2 forcedStep={6} />;
};

export const ManualBook = () => <BookPageV2 forceManual forcedStep={1} />;
