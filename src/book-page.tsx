  ...
  return (
    <div className="edo-page-enter grid w-full edo-hairline md:h-full md:overflow-hidden md:grid-cols-book md:grid-rows-app">
      ...
      <div ref={contentScrollRef} className="bg-white overflow-auto flex flex-col md:col-start-2 md:col-span-2 md:row-start-2 md:min-h-0">
        {mode === 'manual' && (
          <div className="px-5 flex items-center justify-between gap-3 bg-muted min-h-control box-border shrink-0 border-b border-hairline">
...
const Step0Configurator = ({ lang, global, setGlobal, sessions, setSessions, activeIdx, setActiveIdx, onApply, onSkip, onReset }: AnyProps) => {
  ...
  return (
    <div className="min-w-0 overflow-y-auto h-full">
      <div className="px-5 flex items-center justify-between gap-3 bg-muted min-h-control box-border sticky top-0 z-local border-b border-hairline">
