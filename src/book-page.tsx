...
import {
  BOOK_PLATEAUX, CYCLO_EXTRAS, EQUIPE, PP_UNIT, CFG_MATRIX,
  fmtEUR, slotIdFor, cfgMatrixKey, packshotRate,
  recommendSession, recommendProjectLevel, computePostprodPrice,
  makeBlankSession, isSessionValid, computePriceBreakdown,
  buildSessionsData as buildSessionsDataEngine,
} from './lib/booking-engine';
import type {
  BookingSessionData, BilingualText, BookPlateau, BookingSession, ConfigGlobal,
  DateSelection, TeamState, QuoteBreakdown, PostprodState, SlotState,
  QuoteRow, QuoteGroup, PriceBreakdown, CfgEntry, Recommendation, QuoteLabels,
} from './lib/booking-engine';
...
const BookPageV2 = ({ forcedStep, forceManual }: BookPageV2Props = {}) => {
  ...
  const priceBreakdown = useMemoBook<PriceBreakdown>(() => computePriceBreakdown({ plateau, slotIds, slots, lang, labels: quoteLabels }), [plateau, slotIds, slots, lang, quoteLabels]);
  ...
  const buildSessionsData = useCallbackBook((): BookingSessionData[] => buildSessionsDataEngine({
    slotIds,
    plateau,
    slots,
    configApplied,
