...
const AssistantHeader = ({
 ...
 <span className="font-mono text-xs font-normal uppercase tracking-widest text-muted-foreground">Assistant</span>
 {mode === 'chat' && (
 <span
 className={cn(
...
const ChatSessionList = ({
 ...
 <span className="font-mono text-xs font-normal uppercase tracking-widest text-muted-foreground">{t('assistant.history')}</span>
 <Button
 type="button"
 onClick={onClose}
