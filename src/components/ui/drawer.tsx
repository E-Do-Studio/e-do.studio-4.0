...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Backdrop
      ...
      className={cn(
        // Fond noir franc, sans flou : le site n'utilise pas de verre dépoli.
        // Opacité reprise du bottom-sheet maison (0.55).
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      // Le site aligne le titre à gauche et pose un filet sous l'en-tête, au
      // lieu du bloc centré de shadcn.
      className={cn(
        "flex shrink-0 flex-row items-center justify-between gap-3 border-b border-border p-4 text-left group-data-[swipe-axis=y]/drawer-popup:text-left",
        className
      )}
      {...props}
    />
...
function DrawerFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "mt-auto flex shrink-0 flex-col gap-2 border-t border-border p-3",
        className
      )}
      {...props}
    />
...
function DrawerTitle({ className, ...props }: DrawerPrimitive.Title.Props) {
  return (
    <DrawerPrimitive.Title
      ...
      className={cn(
        "font-mono text-label font-normal uppercase tracking-label text-foreground",
        className
      )}
      {...props}
    />
