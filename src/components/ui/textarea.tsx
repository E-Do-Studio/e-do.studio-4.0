  ...
  "flex w-full transition-colors outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        bento:
          "h-full resize-none border-0 bg-background px-5 py-4 font-sans text-base font-light leading-normal tracking-tight text-foreground placeholder:font-mono placeholder:text-xs placeholder:font-normal placeholder:uppercase placeholder:tracking-widest placeholder:opacity-100 focus:bg-muted focus:placeholder:opacity-0 aria-invalid:text-destructive aria-invalid:placeholder:text-destructive",
      },
    },
    defaultVariants: {
      variant: "default",
