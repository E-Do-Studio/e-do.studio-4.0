...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // `ring-1` retiré : la marque sépare par le filet 1px de la grille
        // bento, pas par un halo. Une carte posée dans une `BentoCell` ne
        // dessine rien — la gouttière du parent fait la séparation.
