...
export const PRERENDER_ROUTE_PAIRS: readonly RoutePair[] = [
  ...
  { metaKey: 'plateau-horizontal',  fr: '/fr/plateau/horizontal', en: '/en/plateau/horizontal' },
  { metaKey: 'plateau-vertical',    fr: '/fr/plateau/vertical',   en: '/en/plateau/vertical' },
  { metaKey: 'plateau-eclipse',     fr: '/fr/plateau/eclipse',    en: '/en/plateau/eclipse' },
