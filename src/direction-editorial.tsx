...
const DirectionA = () => {
 ...
 className={cn(
 'group flex aspect-[4/3] min-w-0 cursor-pointer flex-col justify-between bg-background px-3 py-3 text-left text-foreground transition-colors duration-150 hover:bg-muted md:aspect-auto md:h-full md:w-full md:px-4 md:py-4',
 ...
 <HoverMarquee className="text-base font-medium tracking-tight leading-tight text-foreground">
 {m[lang].t}
 </HoverMarquee>
 <HoverMarquee className="mt-1 text-xs font-mono uppercase tracking-wide text-muted-foreground transition-colors duration-200 group-hover:text-foreground">
 {m[lang].sub}
 </HoverMarquee>
 </div>
 </Button>
